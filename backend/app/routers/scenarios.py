...
@router.post("/scn-auth-001", dependencies=[Depends(require_role("viewer"))])
...
@router.post("/scn-session-002", dependencies=[Depends(require_role("viewer"))])
...
@router.post("/scn-doc-003", dependencies=[Depends(require_role("viewer"))])
...
@router.post("/scn-doc-004", dependencies=[Depends(require_role("viewer"))])
...
@router.post("/scn-svc-005", dependencies=[Depends(require_role("viewer"))])
...
@router.post("/scn-corr-006", dependencies=[Depends(require_role("viewer"))])
