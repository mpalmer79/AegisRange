...
class TestIncidentSerializer(unittest.TestCase):
    ...
    def test_affected_resources_shape(self) -> None:
        ...
        self.assertEqual(
            set(ar.keys()), {"documents", "sessions", "services", "actors"}
        )
...
class TestTimelineEntrySerializer(unittest.TestCase):
    def test_fields(self) -> None:
        ...
        self.assertEqual(
            set(d.keys()), {"timestamp", "entry_type", "entry_id", "summary"}
        )
...
class TestRiskProfileSerializer(unittest.TestCase):
    def test_fields(self) -> None:
        ...
        class FakeProfile:
            ...
            peak_score: int = 90
            contributing_rules: list = dc_field(
                default_factory=lambda: ["DET-AUTH-001"]
            )
...
class TestMitreSerializers(unittest.TestCase):
    def test_mapping_fields(self) -> None:
        ...
        class FakeMapping:
            ...
            kill_chain_phases: list = dc_field(
                default_factory=lambda: ["initial_access"]
            )
