...
import type { MissionHelp } from '@/lib/types';
...
const QUICKSTART_LINES: string[] = [
  'Welcome to AegisRange. You are the defender (Blue) — your job is to',
  'detect what the adversary is doing, correlate it into an incident,',
  'and contain the account before damage lands.',
  '',
...
const STUCK_PROMPT: string[] = [
  ...
  '',
  '• If the adversary hasn\'t acted yet, wait a few seconds — events',
  '  arrive over the difficulty\'s time budget.',
];
 ...
 *                 `hint` in the console.
 */
export default function OpsManual({ runId, open, onClose }: Props) {
